...
local RAID10_CONTENT = data:AddContentType(AL["[SOD]10 Raids"], ATLASLOOT_RAID20_COLOR)
	...
	items = {
		{ -- BFDGhamoora
			...
			[NORMAL_DIFF] = {
				...
				{ 4,  209432 }, -- Ghamoo-ra's Cinch
				{ 5,  209678 }, -- Mantle of the Thresher Slayer
				{ 6,  209824 }, -- Shimmering Shoulderpads
				{ 7,  209523 }, -- Shimmering Thresher Cape
		...
		{ -- BFDLadySarevess
			...
			[NORMAL_DIFF] = {
				...
				{ 2,  211842 }, -- Rakkamar's Tattered Thinking Cap
				{ 3,  209563 }, -- Naga Heartrender
				{ 4,  209680 }, -- Waterproof Scarf
				{ 5,  211789 }, -- Artemis Cowl
				{ 6,  211843 }, -- Mask of Scorn
				{ 7,  209527 }, -- Naga Battle Gauntlets
				{ 8,  209822 }, -- Strength of Purpose
				{ 9,  209564 }, -- Guardian's Trident
				{ 10,  209565 }, -- Band of Deep Places
				{ 11,  209823 }, -- Signet of Beasts
				{ 12,  209679 }, -- Azshari Novice's Shoulderpads
				{ 13,  209525 }, -- Honed Darkwater Talwar
				{ 14,  5952 }, -- Corrupted Brain Stem
			},
		},
		{ -- BFDGelihast
			name = AL["Gelihast"],
			...
			AtlasMapBossID = 3,
			[NORMAL_DIFF] = {
				{ 1,  209568 }, -- Algae Gauntlets
				{ 2,  211506 }, -- Twilight Avenger's Boots
				{ 3,  211510 }, -- Twilight Slayer's Cowl
				{ 4,  209573 }, -- Wrathful Spire
				{ 5,  209569 }, -- Murloc Hide Kneeboots
				{ 6,  211504 }, -- Twilight Avenger's Chain
				{ 7,  209683 }, -- Twilight Invoker's Shawl
				{ 8,  209559 }, -- Twilight Sage's Walking Stick
				{ 9,  209820 }, -- Black Shroud Choker
				{ 10,  209567 }, -- Coral Reef Axe
				{ 11,  209571 }, -- Deadlight
				{ 12,  209670 }, -- Skinwalkers
				{ 13,  209570 }, -- Tome of Cavern Lore
				{ 14,  211505 }, -- Twilight Avenger's Helm
				{ 15,  211507 }, -- Twilight Elementalist's Cowl
				{ 16,  211508 }, -- Twilight Elementalist's Footpads
				{ 17,  209671 }, -- Twilight Invoker's Robes
				{ 18,  209821 }, -- Ring of Shadowsight
				{ 19,  211509 }, -- Twilight Elementalist's Robe
				{ 20,  211511 }, -- Twilight Slayer's Footpads
				{ 21,  211512 }, -- Twilight Slayer's Tunic
				{ 22,  211491 }, -- Bottomless Murloc Skin Bag
		...
		{ -- BFDBaronAquanis
			...
			[NORMAL_DIFF] = {
				...
				{ 2,  204807 }, -- Fathomblade
				{ 3,  209828 }, -- Sub-Zero Pauldrons
				{ 4,  209421 }, -- Cord of Aquanis
				{ 5,  209590 }, -- Cracked Water Globe
				{ 6,  209676 }, -- Shoulderguards of Crushing Depths
				{ 7,  209825 }, -- Droplet Choker
				{ 8,  209423 }, -- Flowing Scarf
				{ 9,  209422 }, -- High Tide Choker
				{ 10,  204804 }, -- Hydraxian Bangles
				{ 11,  211852 }, -- Handwraps of Befouled Water
		...
		{ -- BFDTwilightLordKelris
			...
			AtlasMapBossID = 5,
			[NORMAL_DIFF] = {
				{ 1,  5881 }, -- Head of Kelris
				{ 2,  209694 }, -- Blackfathom Ritual Dagger
				{ 3,  209686 }, -- Jagged Bone Necklace
				{ 4,  209668 }, -- Signet of the Twilight Lord
				{ 5,  211457 }, -- Twilight Defender's Girdle
				{ 6,  209672 }, -- Black Fingerless Gloves
				{ 7,  209667 }, -- Gaze Dreamer Leggings
				{ 8,  209674 }, -- Phoenix Ignition
				{ 9,  211455 }, -- Slick Fingerless Gloves
				{ 10,  209817 }, -- Voidwalker Brooch
			},
		},
		{ -- BFDOldSerrakis
			name = AL["Lorgus Jett"],
			...
			[NORMAL_DIFF] = {
				...
				{ 3,  209581 }, -- Silver Hand Sabatons
				{ 4,  211508 }, -- Twilight Elementalist's Footpads
				{ 5,  209818 }, -- Sun-Touched Crescent
				{ 6,  211504 }, -- Twilight Avenger's Chain
				{ 7,  211510 }, -- Twilight Slayer's Cowl
				{ 8,  209574 }, -- Discarded Tenets of the Silver Hand
				{ 9,  209682 }, -- Sturdy Hood
				{ 10,  211506 }, -- Twilight Avenger's Boots
				{ 11,  211505 }, -- Twilight Avenger's Helm
				{ 12,  211509 }, -- Twilight Elementalist's Robe
				{ 13,  209669 }, -- Twilight Invoker's Shoes
				{ 14,  211511 }, -- Twilight Slayer's Footpads
				{ 15,  209577 }, -- Fist of the Wild
				{ 16,  209578 }, -- Glowing Leather Bands
				{ 17,  209671 }, -- Twilight Invoker's Robes
				{ 18,  209683 }, -- Twilight Invoker's Shawl
				{ 19,  211512 }, -- Twilight Slayer's Tunic
			},
		},
		{ -- BFDAkumai
			name = AL["Aku'mai"],
			...
			[NORMAL_DIFF] = {
				...
				{ 4,  209685 }, -- Ancient Moss Cinch
				{ 5,  209688 }, -- Bael Modan Blunderbuss
				{ 6,  211452 }, -- Perfect Blackfathom Pearl
				{ 7,  209692 }, -- Sentinel Pauldrons
		...
		{ -- BFDTrash
			...
			ExtraList = true,
			[NORMAL_DIFF] = {
				{ 1,  1454 }, -- Axe of the Enforcer
				{ 2,  3415 }, -- Staff of the Friar
				{ 3,  3414 }, -- Crested Scepter
				{ 4,  1481 }, -- Grimclaw
				{ 5,  2567 }, -- Evocator's Blade
				{ 6,  3413 }, -- Doomspike
				{ 7,  3417 }, -- Onyx Claymore
				{ 8,  1491 }, -- Ring of Precision
				{ 9,  2271 }, -- Staff of the Blessed Seer
				{ 10, 1486 }, -- Tree Bark Jacket
				{ 11, 3416 }, -- Martyr's Chain
				{ 12, 6906 }, -- Algae Fists
				{ 13, 6907 }, -- Tortoise Armor
				{ 14, 6914 }, -- Soran'ruk Fragment
				{ 15, 5879 }, -- Twilight Pendant
				{ 16, 5952 }, -- Corrupted Brain Stem
			},
		},
